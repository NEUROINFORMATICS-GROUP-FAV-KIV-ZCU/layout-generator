 ...
 * annotation was not found in a parsed class object.
 * 
 * @author Jakub Krauz
 */
public class FormNotFoundException extends TemplateGeneratorException {
    ...
    public FormNotFoundException() {
        super("The @Form annotation was not found in the parsed class(es).");
    }
